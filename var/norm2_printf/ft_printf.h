...
char					*ft_flag_pad(char *str, t_struct *fl);
char					*ft_flag_zero(char *str, t_struct *fl, va_list args);
char					*ft_flag_width(char *str, t_struct *fl);
char					*ft_flag_arg(char *str, t_struct *fl, va_list args);
char					*ft_flag_prc(char *str, t_struct *fl, va_list args);
...
int						ft_nbrlen_hex(unsigned long int n);
int						ft_nbrlen_hex_addr(unsigned long long int n);
void					ft_putchar(char c);
void					ft_putstr(char *s);
void					ft_putstrlen(char *s, int len);
void					ft_putnbr(long int n);
void					ft_putnbr_hex(unsigned long int n);
void					ft_putnbr_hex_up(unsigned long int n);
void					ft_putnbr_hex_addr(unsigned long long int n);
